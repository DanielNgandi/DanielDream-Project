...
class DashboardUI:
    def __init__(self, master):
        self.master = master
        master.title("Dream Waters Inventory System| Developed by Daniel mwangangi")
        ...
        self.icon_image = tk.PhotoImage(file=r"C:\DanielDream Project\Images\Dreamlogo1.png")
        self.icon_image = self.icon_image.subsample(8, 8)
        self.title_label = tk.Label(self.top_frame, text="Dream Waters Investment", font=("Arial", 19), image=self.icon_image, compound="left", bg="#4da6ff", fg="white", padx=0, pady=0)
        ...
        self.image_paths = [r"C:\DanielDream Project\Images\Dream1.png", r"C:\DanielDream Project\Images\Dreamlogo.png", r"C:\DanielDream Project\Images\Dreamlogo1.png"]
        ...
        for path in self.image_paths:
            ...
            resized_image = image.resize((150, 100), PIL.Image.Resampling.LANCZOS)
    ...
    def add_product(self):
        add_product_window =AddStockWindow()
        pass
